...
def vel_callback(msg):
    ...
    # speed_wish_left = linear * 2 - speed_wish_right
        ...
        x = abs(convert_trans_rot_vel_to_steering_angle(linear, angle, WHEEL_DIST))
     
    #rospy.loginfo("x : %s, right: %s. left: %s, wheelbase: %f", "/cmd_vel", x, speed_wish_right, speed_wish_left, WHEEL_DIST)
