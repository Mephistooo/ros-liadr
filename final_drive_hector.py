...
class Driver:
    ...
    def __init__(self):
        ...
        self._max_speed = rospy.get_param('~max_speed', 0.7)
    ...
    def _velocity_received_callback(self, message):
        ...
        #print(message.linear, message.angular)
         #rotation 
        if linear == 0 :
            right_speed = angular * self._wheel_base / 2.0
    ...
    def move(self, motor_id, speed_percent):
        ...
        #if duty_cycle < self._move_threshold:
        #    duty_cycle += self._move_threshold
